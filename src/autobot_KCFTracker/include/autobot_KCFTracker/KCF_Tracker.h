//
// Created by autobot on 2021/7/30.
//
...
public:
    ...
    //dynamic_reconfigure::Server<autobot_astra::KCFTrackerPIDConfig> server;
    //dynamic_reconfigure::Server<autobot_astra::KCFTrackerPIDConfig>::CallbackType f;
