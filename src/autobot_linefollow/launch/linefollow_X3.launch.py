...
'/sllidar_launch.py'])
    ...
    bringup_node = IncludeLaunchDescription(PythonLaunchDescriptionSource([os.path.join(get_package_share_directory('autobot_bringup'), 'launch'),
'/autobot_bringup_X3_launch.py'])
)
    Joy_node = Node(
        package='joy',
        executable='joy_node',
