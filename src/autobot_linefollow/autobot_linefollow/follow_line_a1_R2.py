...
import threading
import math
from autobot_linefollow.follow_common import *
RAD2DEG = 180 / math.pi
print ("import finish")
...
class LineDetect(Node):
	def __init__(self,name):
		...
		self.Mouse_XY = (0, 0)
		self.hsv_text = "/root/autobot_ros2_ws/autobot_ws/src/autobot_linefollow/autobot_linefollow/LineFollowHSV.text"
