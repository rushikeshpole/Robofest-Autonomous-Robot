...
import threading
import math
from autobot_voice_ctrl.follow_common import *
...
class LineDetect(Node):
	def __init__(self,name):
		...
		self.Mouse_XY = (0, 0)
		self.hsv_text = "/root/autobot_ros2_ws/autobot_ws/src/autobot_voice_ctrl/autobot_voice_ctrl/LineFollowHSV.text"
