...
class mediapipeCloud:public rclcpp ::Node
{
    ...
    rclcpp::Subscription<autobot_msgs::msg::PointArray>::SharedPtr sub_point;
...
public:
	...
	:Node("mediapipe_point")
    {
        ...
        sub_point = this->create_subscription<autobot_msgs::msg::PointArray>("/mediapipe/points",50,std::bind(&mediapipeCloud::handle_point,this,_1));
    }
private:
