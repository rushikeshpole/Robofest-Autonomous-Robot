...
#include "autobot_msgs/msg/point_array.hpp"
...
class mediapipeCloud:public rclcpp ::Node
{
   ...
   rclcpp::Subscription<autobot_msgs::msg::PointArray>::SharedPtr subscription_;
   rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pub_pcl_;
	...
	public:
	  ...
	  {            
	  	subscription_ = this->create_subscription<autobot_msgs::msg::PointArray>("/mediapipe/points",50,std::bind(&mediapipeCloud::handle_point,this,std::placeholders::_1));
	  	pub_pcl_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("/mediapipe_cloud", 1000);
	  	
	  }
	  	private:
	  	  void handle_point(const std::shared_ptr<autobot_msgs::msg::PointArray> msg)
	  	  {
