...
class FaceEyeDetection:
    def __init__(self):
        ...
        self.eyeDetect = cv.CascadeClassifier(
            rospkg.RosPack().get_path("autobot_mediapipe") + "/scripts/file/haarcascade_eye.xml")
        self.faceDetect = cv.CascadeClassifier(
            rospkg.RosPack().get_path("autobot_mediapipe") + "/scripts/file/haarcascade_frontalface_default.xml")
