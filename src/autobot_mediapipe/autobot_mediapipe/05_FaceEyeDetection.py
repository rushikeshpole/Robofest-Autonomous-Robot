...
#import define msg
from autobot_msgs.msg import PointArray
#import commom lib
import cv2 as cv
import numpy as np
import time
...
class FaceEyeDetection(Node):
    def __init__(self,name):
        ...
        self.eyeDetect = cv.CascadeClassifier( "/root/autobot_ros2_ws/autobot_ws/src/autobot_mediapipe/autobot_mediapipe/file/haarcascade_eye.xml")
        self.faceDetect = cv.CascadeClassifier(
"/root/autobot_ros2_ws/autobot_ws/src/autobot_mediapipe/autobot_mediapipe/file/haarcascade_eye.xml")
