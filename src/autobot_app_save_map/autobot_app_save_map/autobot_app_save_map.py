from autobot_web_savmap_interfaces.srv import WebSaveMap                                                            
...
class MinimalService(Node):
    ...
    def __init__(self):
        ...
        self.srv = self.create_service(WebSaveMap, 'autobotAppSaveMap', self.add_three_ints_callback)       # CHANGE
    ...
    def add_three_ints_callback(self, request, response):
        ...
        map_path = "/home/autobot/cartoros2/data/maps/" + map_name
        ...
        try:
            conn = sqlite3.connect("/home/autobot/cartoros2/data/xgo.db")
            c = conn.cursor()
